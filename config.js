var config = {
    ...
    speech : {
        projectId: 'capstone-design-145308',
        keyFilename: './Capstone Design-155c181e1104.json',
        keyword : "Smart Mirror",
        model : "smart_mirror.pmdl", // The name of your model
        sensitivity : 0.9, // Keyword getting too many false positives or not detecting? Change this.
        continuous: false // After a keyword is detected keep listening until speech is not heard
    },
    layout: "main",
    greeting : ["Capstone Design team MiroT "], // An array of greetings to randomly choose from
    ...
    */
    ...
    // YouTube
    youtube: {
      key : "AIzaSyDsQb7kpVXep074vF-OLyEmDgXThivmCdI" // Your YouTube API key
    },
    // SoundCloud
    soundcloud: {
